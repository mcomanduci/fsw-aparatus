    ...
    return (
      <div className="flex w-full flex-col items-end gap-3 pt-6 pr-5 pb-0 pl-10">
        <div className="bg-secondary flex max-w-[calc(100%-40px)] items-center gap-2.5 rounded-full px-4 py-3">
          <p className="text-foreground wrap-break-words truncate text-sm leading-[1.4] font-normal whitespace-normal">
            {content}
          </p>
        </div>
      </div>
  ...
  return (
    <div className="flex w-full flex-col gap-3 pt-6 pr-14 pb-0 pl-3">
      <div className="flex w-full gap-2">
        ...
        <div className="text-foreground wrap-break-words max-w-full text-sm leading-[1.4] font-normal whitespace-normal">
